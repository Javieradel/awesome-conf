...
globalkeys = gears.table.join(
    ...
    awful.key(
        ...
        function ()
            ...
            local query = "awesome -k"
            awful.spawn.easy_async(query, function(stdout, stderr, reason, exit_code)
                naughty.notify(
                    {
        ...
        {description = "TEST", group = "user-conf"}),
    ...
    -- Prompt
    awful.key(
        { modkey },            "r",     function () run_shell.launch() end,
    ...
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key(
            ...
            function ()
                ...
                if tag then
                    local s = awful.screen.focused()
                        s.wiboxModKeyW.visible= true
                        gears.timer.start_new(
                            1,
                            function()
                                s.wiboxModKeyW.visible= false
                            end
                        )
                    tag:view_only()
                end
